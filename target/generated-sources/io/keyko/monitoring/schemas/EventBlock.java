...
public class EventBlock extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  @Deprecated public io.keyko.monitoring.schemas.BlockDetails detailsBlock;
   ...
   */
  public EventBlock(java.lang.String id, java.lang.String type, io.keyko.monitoring.schemas.ContractEventDetails details, io.keyko.monitoring.schemas.BlockDetails detailsBlock, java.lang.Integer retries) {
    this.id = id;
    this.type = type;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: detailsBlock = (io.keyko.monitoring.schemas.BlockDetails)value$; break;
   ...
   */
  public io.keyko.monitoring.schemas.BlockDetails getDetailsBlock() {
    return detailsBlock;
  }
   ...
   */
  public static io.keyko.monitoring.schemas.EventBlock.Builder newBuilder() {
    return new io.keyko.monitoring.schemas.EventBlock.Builder();
  }
   ...
   * @return A new EventBlock RecordBuilder
   */
  public static io.keyko.monitoring.schemas.EventBlock.Builder newBuilder(io.keyko.monitoring.schemas.EventBlock.Builder other) {
    if (other == null) {
      return new io.keyko.monitoring.schemas.EventBlock.Builder();
    } else {
      return new io.keyko.monitoring.schemas.EventBlock.Builder(other);
    }
  }
   ...
   * @return A new EventBlock RecordBuilder
   */
  public static io.keyko.monitoring.schemas.EventBlock.Builder newBuilder(io.keyko.monitoring.schemas.EventBlock other) {
    if (other == null) {
      return new io.keyko.monitoring.schemas.EventBlock.Builder();
    } else {
      return new io.keyko.monitoring.schemas.EventBlock.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<EventBlock>
    ...
    private io.keyko.monitoring.schemas.BlockDetails detailsBlock;
    private io.keyko.monitoring.schemas.BlockDetails.Builder detailsBlockBuilder;
    private int retries;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.keyko.monitoring.schemas.EventBlock.Builder other) {
      super(other);
      ...
      if (other.hasDetailsBlockBuilder()) {
        this.detailsBlockBuilder = io.keyko.monitoring.schemas.BlockDetails.newBuilder(other.getDetailsBlockBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.keyko.monitoring.schemas.EventBlock other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.EventBlock.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.EventBlock.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.EventBlock.Builder setType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.EventBlock.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.EventBlock.Builder setDetails(io.keyko.monitoring.schemas.ContractEventDetails value) {
     ...
     * @return This builder.
     */
    public io.keyko.monitoring.schemas.EventBlock.Builder setDetailsBuilder(io.keyko.monitoring.schemas.ContractEventDetails.Builder value) {
      clearDetails();
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.EventBlock.Builder clearDetails() {
      details = null;
      detailsBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.EventBlock.Builder setDetailsBlock(io.keyko.monitoring.schemas.BlockDetails value) {
     ...
     * @return This builder.
     */
    public io.keyko.monitoring.schemas.BlockDetails.Builder getDetailsBlockBuilder() {
      if (detailsBlockBuilder == null) {
        if (hasDetailsBlock()) {
          setDetailsBlockBuilder(io.keyko.monitoring.schemas.BlockDetails.newBuilder(detailsBlock));
        } else {
          setDetailsBlockBuilder(io.keyko.monitoring.schemas.BlockDetails.newBuilder());
        }
      }
     ...
     * @return This builder.
     */
    public io.keyko.monitoring.schemas.EventBlock.Builder setDetailsBlockBuilder(io.keyko.monitoring.schemas.BlockDetails.Builder value) {
      clearDetailsBlock();
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.EventBlock.Builder clearDetailsBlock() {
      detailsBlock = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.EventBlock.Builder setRetries(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.EventBlock.Builder clearRetries() {
    ...
    public EventBlock build() {
      try {
        ...
        if (detailsBlockBuilder != null) {
          ...
          record.detailsBlock = fieldSetFlags()[3] ? this.detailsBlock : (io.keyko.monitoring.schemas.BlockDetails) defaultValue(fields()[3]);
        }
        record.retries = fieldSetFlags()[4] ? this.retries : (java.lang.Integer) defaultValue(fields()[4]);
        return record;
      } catch (org.apache.avro.AvroMissingFieldException e) {
        throw e;
