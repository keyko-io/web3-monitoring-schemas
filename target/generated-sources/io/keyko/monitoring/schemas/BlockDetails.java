...
public class BlockDetails extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public BlockDetails(java.lang.String number, java.lang.String hash, java.lang.String timestamp, java.lang.String nodeName) {
    this.number = number;
    this.hash = hash;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 3: nodeName = (java.lang.String)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public static io.keyko.monitoring.schemas.BlockDetails.Builder newBuilder() {
    return new io.keyko.monitoring.schemas.BlockDetails.Builder();
  }
   ...
   * @return A new BlockDetails RecordBuilder
   */
  public static io.keyko.monitoring.schemas.BlockDetails.Builder newBuilder(io.keyko.monitoring.schemas.BlockDetails.Builder other) {
    if (other == null) {
      return new io.keyko.monitoring.schemas.BlockDetails.Builder();
    } else {
      return new io.keyko.monitoring.schemas.BlockDetails.Builder(other);
    }
  }
   ...
   * @return A new BlockDetails RecordBuilder
   */
  public static io.keyko.monitoring.schemas.BlockDetails.Builder newBuilder(io.keyko.monitoring.schemas.BlockDetails other) {
    if (other == null) {
      return new io.keyko.monitoring.schemas.BlockDetails.Builder();
    } else {
      return new io.keyko.monitoring.schemas.BlockDetails.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<BlockDetails>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.keyko.monitoring.schemas.BlockDetails.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.keyko.monitoring.schemas.BlockDetails other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.number)) {
        this.number = data().deepCopy(fields()[0].schema(), other.number);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.BlockDetails.Builder setNumber(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.BlockDetails.Builder clearNumber() {
      number = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.BlockDetails.Builder setHash(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.BlockDetails.Builder clearHash() {
      hash = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.BlockDetails.Builder setTimestamp(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.BlockDetails.Builder clearTimestamp() {
      timestamp = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.BlockDetails.Builder setNodeName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.BlockDetails.Builder clearNodeName() {
      nodeName = null;
    ...
    public BlockDetails build() {
      try {
        ...
        record.nodeName = fieldSetFlags()[3] ? this.nodeName : (java.lang.String) defaultValue(fields()[3]);
        return record;
