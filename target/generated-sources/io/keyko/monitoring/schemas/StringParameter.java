...
public class StringParameter extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 3488942165868781980L;
   ...
   */
  public StringParameter(java.lang.String name, java.lang.String type, java.lang.String value) {
    this.name = name;
    this.type = type;
    this.value = value;
  }
   ...
   */
  public static io.keyko.monitoring.schemas.StringParameter.Builder newBuilder() {
    return new io.keyko.monitoring.schemas.StringParameter.Builder();
  }
   ...
   * @return A new StringParameter RecordBuilder
   */
  public static io.keyko.monitoring.schemas.StringParameter.Builder newBuilder(io.keyko.monitoring.schemas.StringParameter.Builder other) {
    if (other == null) {
      return new io.keyko.monitoring.schemas.StringParameter.Builder();
    } else {
      return new io.keyko.monitoring.schemas.StringParameter.Builder(other);
    }
  }
   ...
   * @return A new StringParameter RecordBuilder
   */
  public static io.keyko.monitoring.schemas.StringParameter.Builder newBuilder(io.keyko.monitoring.schemas.StringParameter other) {
    if (other == null) {
      return new io.keyko.monitoring.schemas.StringParameter.Builder();
    } else {
      return new io.keyko.monitoring.schemas.StringParameter.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<StringParameter>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(io.keyko.monitoring.schemas.StringParameter.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(io.keyko.monitoring.schemas.StringParameter other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.name)) {
        this.name = data().deepCopy(fields()[0].schema(), other.name);
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.StringParameter.Builder setName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.StringParameter.Builder clearName() {
      name = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.StringParameter.Builder setType(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.StringParameter.Builder clearType() {
      type = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.StringParameter.Builder setValue(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public io.keyko.monitoring.schemas.StringParameter.Builder clearValue() {
      value = null;
